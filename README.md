...
├─[SIMPLE]─────────────────────┬─[COMPLEX]──────────────────────────┤
│                              │                                     │
│  💬 SimpleKTDSAgent          │  🤖 MagenticOne Multi-Agent        │
│  ┌─────────────────────┐     │  ┌─────────────────────────────────┐│
│  │    Midm-2.0 Base    │     │  │     Orchestrator Agent        ││
│  │  (Friendli API)     │     │  │    (Azure OpenAI GPT-4o)      ││
│  │                     │     │  └─────────────────────────────────┘│
│  │ • 일반 대화         │     │         │                          │
│  │ • 인사말           │     │         ▼                          │
│  │ • 단순 질문응답    │     │  ┌─────────────────────────────────┐│
...
│  ├─ 🏢 HR 관련 ("급여 정보", "휴가 신청", "복리후생", "교육")       │
│  ├─ 📋 게시판 관련 ("공지사항", "이벤트", "식당 메뉴", "교통")       │
│  ├─ 📊 프로젝트 관리 ("진행 현황", "일정", "리소스", "마일스톤")     │
│  ├─ 🔍 KTDS 정보 ("회사 소개", "사업영역", "연혁", "솔루션")        │
│  ├─ 🌐 웹 검색 ("최신 뉴스", "기술 동향", "외부 정보")             │
│  └─ 🔗 멀티홉 쿼리 (여러 도메인에 걸친 복합 질문)                 │
└─────────────────────────────────────────────────────────────────────┘
